...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://github.com/qiaomunanzi/charles7c.github.io/edit/main/docs/:path',
    text: '不妥之处，敬请雅正'
  },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/qiaomunanzi/qxs-docs' },
    {
      icon: {
      ...
      link: 'https://gitee.com/qiaomunanzi'
    },
  ],
